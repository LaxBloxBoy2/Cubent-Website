...
const API_BASE_URL = process.env.API_BASE_URL || 'https://app.cubent.com';
...
Examples:
  ...
  API_BASE_URL=https://app.cubent.com TEST_TOKEN=your_token node test-extension-integration.js
